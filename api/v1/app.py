...
from flask import Flask, jsonify, handled_response, render_template, url_for
...
# Register the blueprint to the Flask app instance
...
def handle_404(exception):
    ...
    return handled_response(jsonify(message), code)
